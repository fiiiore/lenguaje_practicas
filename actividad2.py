...
# -------------------------------------
# 1️ Crear carpeta de salida
# -------------------------------------
os.makedirs("salida", exist_ok=True)

# -------------------------------------
# 2️ Inicializar estructuras para acumular información
# -------------------------------------
...
# -------------------------------------
# 3️ Función para convertir fecha según formato
# -------------------------------------
...
# -------------------------------------
# 4️ Leer el CSV y procesar todo en una sola pasada
# -------------------------------------
